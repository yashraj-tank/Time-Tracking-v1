...
<div class="sidebar">
  ...
  <div class="nav-section">
    <a href="${pageContext.request.contextPath}/manager/dashboard" class="nav-item ${param.page == 'dashboard' ? 'active' : ''}">
      <span class="nav-icon">📊</span> Dashboard
    </a>
    <a href="${pageContext.request.contextPath}/manager/projects" class="nav-item ${param.page == 'projects' ? 'active' : ''}">
      <span class="nav-icon">📁</span> My Projects
    </a>
    <a href="${pageContext.request.contextPath}/manager/tasks" class="nav-item ${param.page == 'tasks' ? 'active' : ''}">
      <span class="nav-icon">✅</span> My Tasks
    </a>
    <a href="${pageContext.request.contextPath}/manager/task-assignments" class="nav-item">
    <span class="nav-icon">👥</span>
    Task Assignments
	</a>
    <a href="${pageContext.request.contextPath}/manager/project-users" class="nav-item">
    <span class="nav-icon">⚙️</span>
    In Progress Tasks
	</a>
	<a href="${pageContext.request.contextPath}/manager/time-entries" class="nav-item">
    <span class="nav-icon">⏱️</span>
    Time Logs
