...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .verification-pending { color: #ffc107; font-weight: 600; }
        .verification-verified { color: #28a745; font-weight: 600; }
    </style>
</head>
<body>
                                    ...
                                    <tbody>
                                        <c:forEach var="item" items="${statusEntry.value}">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${item.hasUnverified}">
                                                            <span class="verification-pending">⏳ Pending</span>
                                                        </c:when>
                                                        <c:otherwise>
                                                ...
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/developer/tasks/${item.task.taskId}/log" class="btn-log">Log Efforts</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
