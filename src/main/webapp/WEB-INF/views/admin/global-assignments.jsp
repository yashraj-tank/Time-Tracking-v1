                ...
                <tbody>
                    <c:forEach var="item" items="${assignments}">
                        <tr>
                            ...
                            <td>${item.taskTitle} (Task ID: ${item.assignment.taskId})</td>
                            <td>${item.userName}</td>
                            <td>
                                <c:choose>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/admin/tasks/${item.assignment.taskId}/assignments/edit/${item.assignment.taskUserId}" class="btn btn-edit">Edit</a>
                                <a href="${pageContext.request.contextPath}/admin/tasks/${item.assignment.taskId}/assignments/delete/${item.assignment.taskUserId}" class="btn btn-delete" onclick="return confirm('Delete this assignment?')">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
